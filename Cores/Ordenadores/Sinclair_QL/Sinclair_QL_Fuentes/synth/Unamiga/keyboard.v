...
module keyboard ( 
	...
	output [7:0] keys_o,
	output changeScandoubler
);

assign matrix = ql_matrix | special_matrix;
assign keys_o = keys_s;
assign changeScandoubler = scandbldis;
		...
		if(valid) begin
            ...
            key_released <= 1'b1;
				...
				case(byte)
					...
					8'h07:  begin keys_s[7:5] <= key_released ? 3'b111 : 3'b011; end// F12
					
					8'h7e:  scandbldis <= !key_released;// Bloq. Despl.
										
					// cursor keys
					8'h75: begin ql_matrix[8*1+2] <= !key_released; keys_s[0] <= key_released; end // Up
					8'h72: begin ql_matrix[8*1+7] <= !key_released; keys_s[1] <= key_released; end // Down
					8'h6b: begin ql_matrix[8*1+1] <= !key_released; keys_s[2] <= key_released; end // Left
					8'h74: begin ql_matrix[8*1+4] <= !key_released; keys_s[3] <= key_released; end // Right
					...
					8'h5a:  begin ql_matrix[8*1+0] <= !key_released; keys_s[4] <= key_released; end // RET
