...
//============================================================================
//
//  Unamiga Top adapted by Delgrom 03/02/2020
//
//============================================================================
...
module ql (
   // Clocks
	...
	input wire	stm_b12_i,
	input wire	stm_b13_i,
	output wire	stm_b14_o,
	input wire	stm_b15_i
);
...
//wire tv15khz = 1'b0;
// delgrom 15khz switch
reg v_scandoublerD =1'b0;  // delgrom 1'b1 inicia a 15khz, 1'b0 inicia a  vga
reg cnt_changeScandoubler = 1'b0;
wire changeScandoubler;

wire tv15khz = (cnt_changeScandoubler)? v_scandoublerD : status[15]; // delgrom 1'b0 vga, 1'b1 15khz ;;
//
...
data_io(
   ...
   .ss   	( stm_b12_i ),
	...
	.data_in		( osd_start_s & keys_s  ), //combine the start CMD and the keyboard CMD
	.conf_str	( CONF_STR	  ),
	.status		( status 	  ),
...
always @(posedge clk2) begin
	//if(buttons[1] || status[6] || !pll_locked || rom_download || !btn_n_i[1])
	if(buttons[1] || status[6] || !pll_locked || rom_download )
		reset_cnt <= 12'hfff;
	else if(reset_cnt != 0)
...
// delgrom Joystick 
assign js0[3] = ~joy1_up_i;//up
assign js0[2] = ~joy1_down_i;//down
assign js0[1] = ~joy1_left_i;//left
assign js0[0] = ~joy1_right_i;//right
assign js0[4] = ~joy1_p6_i;//fire1

assign js1[3] = ~joy2_up_i;//up
assign js1[2] = ~joy2_down_i;//down
assign js1[1] = ~joy2_left_i;//left
assign js1[0] = ~joy2_right_i;//right
assign js1[4] = ~joy2_p6_i;//fire1
