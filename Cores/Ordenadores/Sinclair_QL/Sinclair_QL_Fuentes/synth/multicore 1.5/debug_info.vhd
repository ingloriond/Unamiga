...
begin
	...
	r_o <= video_s & video_s & video_s & video_s when (runX = '1' and runY = '1') else r_i;
	g_o <= video_s & video_s & video_s & video_s when (runX = '1' and runY = '1') else g_i;
	b_o <= video_s & video_s & video_s & video_s when (runX = '1' and runY = '1') else b_i;
